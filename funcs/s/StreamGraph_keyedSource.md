...
`StreamGraph::keyedSource(name, keyColumn, capacity:size, colNames, colTypes,
...
g.keyedSource("trade", `symbol, 1:0, `time`symbol`price`volume, [DATETIME,SYMBOL,DOUBLE,LONG])
```
